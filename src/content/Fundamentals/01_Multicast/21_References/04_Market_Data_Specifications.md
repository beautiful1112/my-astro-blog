...
- [NYSE Pillar Equities Common Client Specification v2.4j](https://www.nyse.com/publicdocs/nyse/data/Pillar_Equities_Common_Client_Specification_v2.4j.pdf)

Exchange specifications, schemas, channel configuration, and capacity notices change. Always use the currently effective venue documentation for the target environment.
