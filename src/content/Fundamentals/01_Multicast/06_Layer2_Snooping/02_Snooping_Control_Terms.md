...
- **Unknown multicast:** data for a group with no table entry. A platform may flood, drop, or constrain it.
- **Report suppression/proxying:** switch aggregation of host reports, which changes what is visible in uplink captures.
